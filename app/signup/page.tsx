...
const Signup = () => {
  ...
  const [step, setStep] = useState(1); // 1 = email only, 2 = email + password
          ...
          <div className="flex flex-col gap-11 w-full">
            <div className="flex flex-col items-center gap-8">
              ...
              <div className="flex flex-col gap-4 w-full">
                ...
                <button
                  onClick={step === 1 ? handleContinueWithEmail : undefined}
                ...
                >
                  {step === 1 ? "Continue with Email" : "Sign up"}
                </button>
              </div>
