          ...
          <div className="flex-1">
            <div className="p-6 border border-gray-200 rounded-2xl bg-white space-y-4">
              <div className="flex items-center gap-4">
                <img src={jobData.logo} alt={jobData.company} className="w-10 h-10 rounded-md object-cover" />
                <div>
                  <div className="text-sm font-medium text-gray-700">{jobData.company}</div>
                  <div className="text-xs text-gray-500">{jobData.postedDate}</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                <button className="px-3 py-2 border rounded-full text-sm bg-white">Share</button>
                <button className="px-3 py-2 rounded-full text-sm bg-black text-white">Apply</button>
              </div>
            </div>

            <section className="mt-6 p-6 border border-gray-200 rounded-2xl bg-white space-y-4">
              <h2 className="text-xl font-semibold">Description</h2>
              <div className="text-sm text-gray-700 whitespace-pre-line">{jobData.jobDescription}</div>

              <h3 className="text-lg font-semibold mt-4">Key Responsibilities</h3>
              <div className="text-sm text-gray-700 whitespace-pre-line">{jobData.keyResponsibilities}</div>

              <h3 className="text-lg font-semibold mt-4">Job Qualifications</h3>
              <div className="text-sm text-gray-700 whitespace-pre-line">{jobData.jobQualifications}</div>
            </section>
          </div>
          ...
          <aside className="w-full lg:w-80 space-y-4">
            ...
            <div className="p-6 border border-gray-200 rounded-2xl bg-white">
              ...
              <div className="mt-2 flex flex-wrap gap-2">
                {jobData.tags.map((t) => (
                  <span key={t} className="px-2 py-1 bg-gray-100 rounded-full text-sm">{t}</span>
                ))}
              </div>
            </div>
          </aside>
