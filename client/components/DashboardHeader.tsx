      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-4 sm:mb-5">
          <div className="flex items-center gap-4">
            ...
            {isOpportunitiesDetail ? (
              <button onClick={() => navigate('/opportunities')} className="p-2 hover:bg-gray-100 rounded-lg flex items-center">
                ...
                <span className="hidden sm:inline ml-2 text-sm text-gray-700">Back</span>
              </button>
            ) : (
