...
export const profileSchema = z.object({
  ...
  headline: z.string().min(10, "Headline must be at least 10 characters.").max(100, "Headline must not exceed 100 characters.").optional().or(z.literal("")),
  bio: z.string().min(10, "Bio must be at least 10 characters.").max(1000, "Bio must not exceed 1000 characters.").optional().or(z.literal("")),
