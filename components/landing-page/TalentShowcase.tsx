  ...
  const outstandingTalents = [
    {
      ...
      profile: {
        name: "Promise Olaifa",
        image: "https://api.builder.io/api/v1/image/assets/TEMP/b7a14a0aa489cb96b364bfa56de3bb04acfc0e08?width=64",
        isOnline: true,
        isVerified: true,
      },
    },
    {
      ...
      profile: {
        name: "Desmond Awere",
        image: "https://api.builder.io/api/v1/image/assets/TEMP/0764040b7d3fa40fc56c1df4358f3de87596efe6?width=64",
        isOnline: true,
        isVerified: true,
      },
    },
    {
      ...
      profile: {
        name: "Zeenie Ejike",
        image: "https://api.builder.io/api/v1/image/assets/TEMP/8c82ca4b3d3616469ab02084bfa2fd4e1e2c0980?width=64",
        isOnline: true,
        isVerified: true,
      },
    },
  ...
  const outstandingMentors = [
    {
      ...
      image: "https://api.builder.io/api/v1/image/assets/TEMP/62a092bd6bc517738cffbf8ef4fbcb6b9763da78?width=128",
      isVerified: true,
      services: ["Mentoring", "Giving resume feedback", "Participating in User Research", "+4"],
    },
    {
      name: "Desmond Awere",
      title: "Product Designer, ConnectNigeria",
      ...
      bio: "Product Designer & Ux Consultant Product Designer Passionate about how people and technology can create a new and a better world",
      image: "https://api.builder.io/api/v1/image/assets/TEMP/3fb16dd7cc66e6d606a217c67c37ff5bb910a530?width=128",
      isVerified: true,
      services: ["Mentoring", "Giving resume feedback", "Participating in User Research", "+4"],
    },
    {
      ...
      location: "Texas,USA 🇺🇸",
      bio: "Product Designer & Ux Consultant Product Designer Passionate about how people and technology can create a new and a better world",
      image: "https://api.builder.io/api/v1/image/assets/TEMP/e6c405f1f8a640a9e5d63adf52ea7849f582c532?width=128",
      isVerified: true,
      services: ["Mentoring", "Giving resume feedback", "Participating in User Research", "+4"],
    },
  ];
  ...
  const learningPaths = [
    {
      ...
      image: "https://api.builder.io/api/v1/image/assets/TEMP/4bf01fda474c8d498e63c2e0cb4bc008dca99e0a?width=748",
    },
    {
      title: "Whatever the Title",
      classes: "5 classes (4h 56m)",
      image: "https://api.builder.io/api/v1/image/assets/TEMP/d380f60a4797c398d705e893eacfb868043112f3?width=748",
    },
    {
      title: "Whatever the Title",
      classes: "5 classes (4h 56m)",
      image: "https://api.builder.io/api/v1/image/assets/TEMP/96ff905aeec3c249a3dc7d41243aadaabdf0a0aa?width=748",
    },
  ];

  const findTalents = [
    {
      image: "https://api.builder.io/api/v1/image/assets/TEMP/7a7d06d2171bb91f364bf0e0d5ec52c05746b91c?width=748",
      profile: {
        name: "Promise Olaifa",
        image: "https://api.builder.io/api/v1/image/assets/TEMP/b7a14a0aa489cb96b364bfa56de3bb04acfc0e08?width=64",
        isOnline: true,
    ...
    {
      image: "https://api.builder.io/api/v1/image/assets/TEMP/81a84f91e96e10ab18642d5f40839a2152540580?width=748",
      profile: {
        name: "Ebele Okafor",
        image: "https://api.builder.io/api/v1/image/assets/TEMP/187de602f27fe4361036da4edd6ff448b436f4d5?width=64",
        isOnline: false,
        isVerified: true,
      },
    },
    {
      image: "https://api.builder.io/api/v1/image/assets/TEMP/2a3607311420aa86f0588b26f12fdbe95fc1a23c?width=748",
      profile: {
        name: "Zeenie Ejike",
        image: "https://api.builder.io/api/v1/image/assets/TEMP/8c82ca4b3d3616469ab02084bfa2fd4e1e2c0980?width=64",
        isOnline: true,
          ...
          <div className="w-full flex flex-col items-start gap-6">
            <div className="w-full flex flex-col items-start gap-2.5">
              ...
              <div className="w-full flex flex-col md:flex-row md:justify-between md:items-center gap-2">
                ...
                <a href="#" className="text-gray-600 font-geist text-base font-medium leading-[120%] underline hover:text-gray-800">
                  View more
                </a>
              </div>
            </div>
            ...
            <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
              {outstandingTalents.map((talent, index) => (
                <div key={index} className="flex flex-col items-start gap-4 w-full max-w-[374px]">
                  <div className="flex p-6 items-start gap-4 self-stretch rounded-[32px] border border-gray-200 bg-white">
                    <img src={talent.logo} alt={talent.company} className="w-8 h-8 rounded-3xl flex-shrink-0" />
                    <div className="flex flex-col items-start gap-4 flex-1">
                      ...
                      <div className="flex items-center gap-4">
                        <button className="flex py-3.5 px-3.5 justify-center items-center gap-2.5 rounded-3xl border border-gray-200 bg-white hover:bg-gray-50 transition-colors">
                          <span className="text-black font-geist text-base font-medium leading-[120%]">Share </span>
                        ...
                        <button className="flex py-3.5 px-3.5 justify-center items-center gap-2.5 rounded-3xl bg-black hover:bg-gray-900 transition-colors">
                          <span className="text-white font-geist text-base font-medium leading-[120%]">Apply</span>
                  ...
                  <div className="flex items-center gap-2">
                    <div className="relative">
                      <img src={talent.profile.image} alt={talent.profile.name} className="w-8 h-8 rounded-2xl" />
                      <div className={`absolute -bottom-0.5 -right-0.5 w-3 h-3 rounded-lg border-[2.682px] border-white ${talent.profile.isOnline ? 'bg-[#3AB266]' : 'bg-[#B1B1B1]'}`} />
                    </div>
                    <div className="flex items-center gap-2">
          ...
          <div className="w-full flex flex-col items-start gap-6">
            ...
            <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
              {outstandingMentors.map((mentor, index) => (
                <div key={index} className="flex w-full max-w-[374px] p-4 flex-col items-start gap-4 rounded-[32px] border border-gray-200 bg-white">
                    ...
                    <div className="flex flex-col items-start gap-3 self-stretch">
                      <div className="flex items-center gap-3 self-stretch flex-wrap">
                        {mentor.services.slice(0, 2).map((service, idx) => (
                          <div key={idx} className="flex py-2.5 px-2.5 justify-center items-center gap-2.5 rounded-3xl border border-gray-200">
                            <span className="text-gray-950 font-geist text-[13px] leading-[120%]">{service}</span>
                          </div>
                        ))}
                      </div>
                      <div className="flex items-center gap-3 flex-wrap">
                        {mentor.services.slice(2).map((service, idx) => (
                          <div key={idx} className={`flex py-2.5 px-2.5 justify-center items-center gap-2.5 rounded-3xl border border-gray-200 ${service === '+4' ? 'bg-gray-50' : ''}`}>
                            <span className="text-gray-950 font-geist text-[13px] leading-[120%]">{service}</span>
                          </div>
                        ))}
                      </div>
                  ...
                  <button className="flex py-2.5 px-2.5 justify-center items-center gap-2.5 self-stretch rounded-3xl bg-black hover:bg-gray-900 transition-colors">
                    <span className="text-white font-geist text-[13px] font-medium leading-[120%]">Book a session</span>
                  </button>
                </div>
              ))}
            </div>
          ...
          <div className="w-full flex flex-col items-start gap-6">
            ...
            <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
              {learningPaths.map((path, index) => (
                <div key={index} className="relative w-full max-w-[374px] h-[300px] rounded-[32px] overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 h-[114px] flex items-center rounded-b-[32px] bg-black px-4 py-[18px]">
                    <div className="flex flex-col items-start gap-11">
                      ...
                      <div className="text-white font-geist text-[13px] leading-[120%]">
                        <span className="font-bold">{path.classes.split(' ')[0]} {path.classes.split(' ')[1]} </span>
                        <span>{path.classes.split(' ').slice(2).join(' ')}</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
              {findTalents.map((talent, index) => (
                <div key={index} className="flex flex-col items-start gap-4">
                  <img src={talent.image} alt="Talent work" className="w-full max-w-[374px] h-[280px] rounded-[32px] object-cover" />
                  <div className="flex items-center gap-2">
                    <div className="relative">
                      <img src={talent.profile.image} alt={talent.profile.name} className="w-8 h-8 rounded-2xl" />
                      <div className={`absolute -bottom-0.5 -right-0.5 w-3 h-3 rounded-lg border-[2.682px] border-white ${talent.profile.isOnline ? 'bg-[#3AB266]' : 'bg-[#B1B1B1]'}`} />
